...
2. **Exportar**: copiá el HTML generado y pegalo directamente en el editor del [SIA](https://sia.frba.utn.edu.ar/) (no se sube ningún archivo). Opcionalmente, descargá el archivo `.html` como respaldo, o abrí una vista previa antes de usarlo.
